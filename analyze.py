...
while True:
    ...
    {{
        ...
        quality_score: 1-5,
        agent_mistakes: [список помилок зі списку: incorrect_info, ignored_question, unnecessary_escalation, no_resolution, long_response_time. Якщо немає - пустий список]
    }}
    """
